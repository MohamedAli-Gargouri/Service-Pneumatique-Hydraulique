...
export function VerifyInputs(TextInputsList,EmailInputList, SelectInputsList, NumbersList, PhoneNumbersList,PasswordList,ConfirmPasswordList,IsLightMode) {
...
VerifyInputs.propTypes = {
  ...
  SelectInputsList: PropTypes.arrayOf(PropTypes.arrayOf(
    PropTypes.shape({
