...
try{
 const promise =new Promise((resolve,reject)=>{setTimeout(()=>{
  ...
  CreateToast(
    promise,
    ReactDOMServer.renderToStaticMarkup(<TranslatedText TranslationPath="UCP.DialogMessages.Products.AddProduct_Success"/>),
    ReactDOMServer.renderToStaticMarkup(<TranslatedText TranslationPath="UCP.DialogMessages.Products.AddProduct_Success"/>),
    ReactDOMServer.renderToStaticMarkup(<TranslatedText TranslationPath="UCP.DialogMessages.Promise.Pending"/>),
    ReactDOMServer.renderToStaticMarkup(<TranslatedText TranslationPath="UCP.DialogMessages.Products.AddProduct_Error"/>),
    "promise",
...
<div  className="mt-4 h-full gap-2 w-full Description col-span-2 md:col-span-1 flex flex-col items-center  justify-center">
    ...
    <Input   labelProps={{style:{color:LightModeState==LightMode().type?"black":"white"}}}
     label={<TranslatedText TranslationPath="UCP.AddProduct.TabInputs.PName"/>} 
     icon={<i class="fa-solid fa-info"></i>} />
    ...
    <Input   labelProps={{style:{color:LightModeState==LightMode().type?"black":"white"}}}
    label={<TranslatedText TranslationPath="UCP.AddProduct.TabInputs.PPrice"/>}   icon={<i class="fa-solid fa-dollar-sign"></i>} /> 
    <Input   labelProps={{style:{color:LightModeState==LightMode().type?"black":"white"}}} 
    label={<TranslatedText TranslationPath="UCP.AddProduct.TabInputs.PCode"/>}   icon={<i class="fa-solid fa-barcode"></i>} />

    <Input  labelProps={{style:{color:LightModeState==LightMode().type?"black":"white"}}}
     label={<TranslatedText TranslationPath="UCP.AddProduct.TabInputs.StoreQuantity"/>}   icon={<i class="fa-solid fa-store"></i>} />
    <Input   labelProps={{style:{color:LightModeState==LightMode().type?"black":"white"}}} 
    label={<TranslatedText TranslationPath="UCP.AddProduct.TabInputs.StockQuantity"/>}   icon={<i class="fa-solid fa-warehouse"></i>} />
    <Textarea  labelProps={{style:{color:LightModeState==LightMode().type?"black":"white"}}}  size="lg"   
    label={<TranslatedText TranslationPath="UCP.AddProduct.TabInputs.SDescription"/>}  defaultValue=""/>
...
data={
  [
    {
      label:<TranslatedText TranslationPath="UCP.AddProduct.TabFilter.LDescription"/>,
    ...
    <Textarea size="lg" label={<TranslatedText TranslationPath="UCP.AddProduct.TabFilter.LDescription"/>}  defaultValue=""/>


  </div>      
    },
    {
      label: < TranslatedText TranslationPath="UCP.AddProduct.TabFilter.Additonalinfo"/>,
    ...
    <Textarea size="lg" label={< TranslatedText TranslationPath="UCP.AddProduct.TabFilter.Additonalinfo"/>}  defaultValue=""/>

        </div>,
    },
    {
      label: < TranslatedText TranslationPath="UCP.AddProduct.TabFilter.Shipping"/>,
    ...
    <Textarea size="lg" label={< TranslatedText TranslationPath="UCP.AddProduct.TabFilter.Shipping"/>}  defaultValue=""/>
