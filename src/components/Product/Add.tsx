...
export default function Product() {
  ...
  /*=======Input Refs========*/
  const BrandRef: React.MutableRefObject<HTMLInputElement> = React.useRef(null);
  const ProductNameRef: React.MutableRefObject<HTMLInputElement> = React.useRef(null);
  const ProductPriceRef: React.MutableRefObject<HTMLInputElement> = React.useRef(null);
  const ProductCodeRef: React.MutableRefObject<HTMLInputElement> = React.useRef(null);
  const StoreQuantityRef: React.MutableRefObject<HTMLInputElement> = React.useRef(null);
  const StockQuantityRef: React.MutableRefObject<HTMLInputElement> = React.useRef(null);
  const BriefDescriptionRef: React.MutableRefObject<HTMLInputElement> = React.useRef(null);
  const LongDescRef: React.MutableRefObject<HTMLInputElement> = React.useRef();
  const InformationRef: React.MutableRefObject<HTMLInputElement> = React.useRef();
  const ShippingRef: React.MutableRefObject<HTMLInputElement> = React.useRef();
