...
const List = [
  {
    ...
    items: 
  [
    {label:<TranslatedText TranslationPath="Global.Footer.Adress"/>,value:<TranslatedText TranslationPath="Global.Footer.Adress_Value1"/>},
    {label:<TranslatedText TranslationPath="Global.Footer.Phone"/>,value:"(+216) 74 21 18 76"},
    {label:<TranslatedText TranslationPath="Global.Footer.Fax"/>,value:"(+216) 74 22 66 09"},
    {label:<TranslatedText TranslationPath="Global.Footer.Email"/>,value:"sph@sph-tn.com"},
  ],
  },
  {
    ...
    items: 
  [
    {label:<TranslatedText TranslationPath="Global.Footer.Adress"/>,value:<TranslatedText TranslationPath="Global.Footer.Adress_Value2"/>},
    {label:<TranslatedText TranslationPath="Global.Footer.Phone"/>,value:"(+216) 74 22 70 74"},
    {label:<TranslatedText TranslationPath="Global.Footer.Fax"/>,value:"(+216) 74 22 70 78"},
    {label:<TranslatedText TranslationPath="Global.Footer.Email"/>,value:"info@sph-tn.com"},
  ],
  }
    ...
    <footer className={`footer relative w-full p-4 ${LightModeState==LightMode().type?"bg-whiteTheme_T2":"bg-darkTheme_T2"}`}>
      ...
      <div className=" mx-auto w-full px-0 text-center">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-6">
          ...
          <img src={logo} alt="logo-ct" className="w-[7rem] h-[4rem] m-4" /> <h5>Service Pneumatique Hydraulique</h5>
          </div>
        ...
        <div className={`w-full  flex  flex-col  flex-wrap justify-center items-center mt-5`}>
          ...
          >
            &copy; {currentYear} <a href="https://www.facebook.com/ServicePneumatiqueHydraulique"><TranslatedText TranslationPath="Global.Footer.Rights"/></a>

          </Typography>
            <Typography as="small"  color="inherit" className={" underline underline-offset-4"} >
