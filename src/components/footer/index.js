      ...
      <div className=" mx-auto w-full max-w-7xl px-8">
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                ...
                <Typography
                  color="inherit"
                  variant="small"
                  className={`mt-4 mb-3 font-medium opacity-40`}
        ...
        <div className={`mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between `}>
          ...
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            <Typography as="a" href="#" color="inherit" className={`opacity-80 transition-opacity hover:opacity-100 `}>
              <svg className="h-5 w-5" fill="inherit" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fill-rule="evenodd"
