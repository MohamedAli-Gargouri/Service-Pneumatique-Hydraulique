...
const TABLE_HEAD = [
  {
    label: <TranslatedText TranslationPath="UCP.CategoryTable.TabHeader.CategoryID" />,
    value: 'Category ID',
  },
  {
    label: <TranslatedText TranslationPath="UCP.CategoryTable.TabHeader.CategoryName" />,
    value: 'Category Name',
  },
  {
    label: <TranslatedText TranslationPath="UCP.CategoryTable.TabHeader.CategoryType" />,
    value: 'Category Type',
  },
  { label: '', value: '' },
];
        ...
        Notify.displayPromiseNotification(
          ...
          [
            ReactDOMServer.renderToStaticMarkup(
              <TranslatedText TranslationPath="UCP.DialogMessages.Category.AddCategory_NamedUsed" />,
            ),
          ],
          ['CATEGORY_ERROR02'],
  ...
  return (
    <Card>
                ...
                <tr key={CategoryID}>
                  ...
                  <td className={classes}>
                    <div className="flex flex-col">
                      <Typography variant="small" className="font-normal">
                        {type == 1 ? (
                          <TranslatedText TranslationPath="UCP.CategoryTable.TabHeader.CategoryTypeValue1" />
                        ) : (
                          <TranslatedText TranslationPath="UCP.CategoryTable.TabHeader.CategoryTypeValue2" />
                        )}
                      </Typography>
                    </div>
                  </td>
      ...
      <ConfirmDialog
        ...
        Title={<TranslatedText TranslationPath="UCP.DialogMessages.Category.DeleteCategory_Title" />}
        Content={<TranslatedText TranslationPath="UCP.DialogMessages.Category.DeleteCategory_Confirm" />}
      />
    </Card>
  );
}
