...
const TABLE_HEAD = [
  { label: '', value: '' },
  {
    label: <TranslatedText TranslationPath="UCP.InvoiceProductList.TabHeader.ProductCode" />,
    value: 'Product Code',
  },
  {
    label: <TranslatedText TranslationPath="UCP.InvoiceProductList.TabHeader.Product" />,
    value: 'Product',
  },
  {
    label: <TranslatedText TranslationPath="UCP.InvoiceProductList.TabHeader.Price" />,
    value: 'Price',
  },
  {
    label: <TranslatedText TranslationPath="UCP.InvoiceProductList.TabHeader.Quantity" />,
    value: 'Quantity',
  },
];
