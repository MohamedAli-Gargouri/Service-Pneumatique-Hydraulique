      ...
      <div className="grid col-span-1 grid-cols-2">
        ...
        <div className="col-span-1 flex flex-row gap-1  w-full justify-end items-center">
          ...
          <div className="LightMode mx-1">
            <IconButton size="sm" color="white" variant="text" className="rounded-full" onClick={HandleLightModeSwitch}>
        ...
        <Collapse style={{ position: 'absolute', top: '10vh', left: '0' }} className="z-50" open={open}>
          <Card className={`w-[95M] p-1 h-full`}>
            <Sidebar />
          </Card>
        </Collapse>
      </div>
      <Typography variant="h3" className={` text-white-c text-center xl:text-left col-span-1 `}>
        <IconButton className="rounded-full" onClick={() => window.history.back()}>
