  ...
  return (
    <div className="relative grid min-h-[100vh] w-screen p-8">
      ...
      <div className="flex flex-col-reverse items-center justify-between gap-4 self-start md:flex-row">
        <Card
          className="h-max w-max border border-blue-gray-50 py-4 px-5 shadow-lg shadow-blue-gray-900/5"
          placeholder={undefined}
          onPointerEnterCapture={undefined}
          onPointerLeaveCapture={undefined}
        >
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              onPointerLeaveCapture={undefined}
            >
              Find everything you need to know about Material Tailwind in our official documentation.
            </Typography>
          </Card>
        </a>
        <a href="https://www.material-tailwind.com/blocks?ref=template-cra" target="_blank" rel="noreferrer">
          <Card
            shadow={false}
            className="border border-blue-gray-50 py-4 px-5 shadow-xl shadow-transparent transition-all hover:-translate-y-4 hover:border-blue-gray-100/60 hover:shadow-blue-gray-900/5"
            placeholder={undefined}
          ...
          >
            ...
            <Typography
              ...
              onPointerLeaveCapture={undefined}
            >
              Ready-to-use section, like Hero, Blog, Pricing, and more, for building projects in no time!
            </Typography>
          </Card>
        </a>
        <a
