  ...
  <Carousel/>
    ...
    <div className="flex flex-wrap flex-col md:flex-row md:flex-nowrap">
          ...
          <div className=" flex flex-col items-center justify-center md:items-start flex-wrap animate-RightToLeft ">
            <div>
            <Typography   variant="h4" color="white" className={`m-1 font-extrabold ${LightModeState==LightMode().type?"":"TextDarkMode"} `}><TranslatedText TranslationPath="Home.Services.Service1"/></Typography>
            </div>

            <div>
            <Typography  variant="h4" color="white" className={`m-1 font-extrabold ${LightModeState==LightMode().type?"":"TextDarkMode"}`}><TranslatedText TranslationPath="Home.Services.Service2"/></Typography>
            </div>

            <div>
            <Typography  variant="h4" color="white" className={`m-1 font-extrabold ${LightModeState==LightMode().type?"":"TextDarkMode"}`}><TranslatedText TranslationPath="Home.Services.Service3"/></Typography>
            </div>

            <div>
            <Typography  variant="p" color="white" className={`m-1 font-black p-4 ${LightModeState==LightMode().type?"":"TextDarkMode"}`}><TranslatedText TranslationPath="Home.Services.Service_Description"/></Typography>
            </div>
          </div>
