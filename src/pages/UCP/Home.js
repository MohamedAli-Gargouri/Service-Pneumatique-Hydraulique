      ...
      <div className="flex flex-row items-stretch">
        ...
        <main className="w-full min-h-screen flex flex-col justify-start items-center ">
          ...
          <section className="w-full text-center">
            <Card className={`background-secondary min-h-[82vh] m-2  background-secondary`}>
                ...
                {Info.map((Insight, index) => {
                  return (
                    <motion.div
                      ...
                      custom={index}
                    >
                      <Card className=" bg-inherit text-inherit mt-2 p-2 border-left-4-accent-primary flex flex-col md:flex-row flex-wrap hover:scale-95 justify-stretch gap-2 items-center col-span-1">
