...
import Carousel from "../../components/Carousel"
  export default function User_Control_Panel() {
    ...
    const [Info,SetInfo]=React.useState([
      {Name:"Products",Count:500,logo:<i class="fa-solid fa-boxes-stacked  fa-2x"></i>,msg:"", col:"red"},
      {Name:"Clients",Count:10,logo:<i class="fa-solid fa-users fa-2x"></i>,msg:"",col:"blue"},
      {Name:"Employee",Count:3,logo:<i class="fa-solid fa-user-gear fa-2x"></i>,msg:"",col:"green"},
      {Name:"Orders",Count:50,logo:<i class="fa-solid fa-clipboard-check fa-2x"></i>,msg:"",col:"yellow"}
    ])
    return (<>
...
<SideBar/>
      ...
      <main className="w-full min-h-screen flex flex-col justify-start items-center ">  
        ...
        <TopBar SectionName={"Home"} Icon='<i class="fa-solid fa-house"></i>'  />

        </section>

        <section className="w-full text-center">      
        <Card  className={`min-h-[82vh] m-2 ${LightModeState==LightMode().type?"tc-whiteTheme_T1 bg-whiteTheme_T2":"tc-darkTheme_T1 bg-darkTheme_T2"}`} >
...
<div className=" rounded-md aspect-video  w-full h-full mt-0 col-span-2">
      <video className=" rounded-md" pl width={"100%"} height={"100%"}    controls>
